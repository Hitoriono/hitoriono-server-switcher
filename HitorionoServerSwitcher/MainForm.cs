...
using HitorionoServerSwitcher.Properties;
...
namespace HitorionoServerSwitcher
{
    public partial class MainForm : Form
    {
            ...
            set
            {
                ...
                if (!servicesUp && emergencyMessage.Empty)
                {
                    emergencyMessage = new EmergencyMessage {
                        ...
                        Title = "Services down!",
                        Message = "Some services are experiencing issues. Please check the status page at https://status.hitoriono.com for more information."
                    };
                }
            }
        }
        ...
        public MainForm()
        {
            ...
            new ToolTip().SetToolTip(this.switchButton, "Switch between osu! and hitoriono");
        }
            ...
            try
            {
                ...
                if (switcher.Settings.ReportCrashStatus == ReportCrashStatus.NOT_ASKED)
                {
                    DialogResult result = MessageBox.Show(
                         "Do you want to help hitoriono make the server switcher better by submitting " +
        ...
        private void updateStatus()
        {
            ...
            statusLabel.Text = String.Format("You are connected to {0}", ripple ? "hitoriono" : "osu!");
            switchButton.Text = String.Format("Switch to {0}", ripple ? "osu!" : "hitoriono");
        ...
        private async void switchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Please click 'Yes' on the next message that will appear on your screen to install the HTTPs certificate. It's needed to connect to hitoriono.");
                    }
        ...
        private void DiscordIcon_Click(object sender, EventArgs e) => Process.Start("https://discord.gg/ZVFhepByFT");
        ...
        private void ServerStatusIcon_Click(object sender, EventArgs e) => Process.Start("https://status.hitoriono.com");
