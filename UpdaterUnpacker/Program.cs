    ...
    static class Program
    {
        ...
        public static void UnpackUpdate()
        {
            try
            {
                ...
                foreach (Process p in Process.GetProcessesByName("HitorionoServerSwitcher"))
                {
                    try
                    {
                        p.Kill();
                ...
                try
                {
                    ...
                    if (!File.Exists("HitorionoServerSwitcher.exe"))
                        throw new WarningException("Could not find HitorionoServerSwitcher.exe");
                }
                catch (UnauthorizedAccessException)
                {
                    throw new CriticalErrorException(
                        ...
                        "If have no idea how to slove this, you can re-download the most up-to-date version of the switcher from https://hitoriono.com"
                    );
                }
                ...
                Process.Start("HitorionoServerSwitcher.exe");
            }
